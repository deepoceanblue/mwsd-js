(function(){ //wrapper IIFE 
  ...
  let update = function(userInput) {
    ...
    let inputCached = checkCachedResults(userInput, inputHistory) ;
...
console.log('imCurrent: ' . imCurrent);
      ...
      case 'iast':
        ...
        break;
      case 'none':
        replacedInput = sanitizedInput(new RegExp('[^' + allowedChars + imScheme[imCurrent].join('') + ']{1,}'));
        console.log(replacedInput);
        searchedTerm = convertToHK(replacedInput);
        break;
      }
